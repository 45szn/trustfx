  ...
  const educationResources = [
    {
      ...
      description:
        "Comprehensive guides on password safety, phishing detection, and personal security best practices.",
      features: [
    ...
    },
    {
      ...
      description:
        "Step-by-step guides for account safety features and troubleshooting security-related issues.",
      features: [
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We believe informed users are secure users. That&apos;s why we offer
            comprehensive security education and resources to keep you
            protected.
          </p>
        </div>
          ...
          {educationResources.map((resource) => {
            ...
            return (
              ...
              >
                {/* Background Gradient */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${resource.bgGradient} opacity-50`}
                />
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Subscribe to our security newsletter for the latest updates, tips,
              and threat alerts to keep your investments safe.
            </p>
