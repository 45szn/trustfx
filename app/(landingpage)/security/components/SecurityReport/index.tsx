...
import { AlertTriangle, Mail, Phone, Shield, Clock, ArrowRight } from "lucide-react"
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div ref={sectionRef}>
          ...
          <div className="text-center mb-16">
            ...
            >
              If you suspect any suspicious activity or have security concerns, we want to hear from you immediately.
              Your vigilance helps keep our entire community safe.
            </p>
          </div>
            ...
            <Card className="bg-red-600/20 backdrop-blur-lg border-2 border-red-500/30 shadow-2xl">
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Emergency Security Contact</h3>
                    <p className="text-red-200">For immediate security concerns or suspected breaches</p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white/10 rounded-lg p-6 border border-white/20">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h4 className="text-lg font-semibold text-white">Security Email</h4>
                    </div>
                    <p className="text-red-200 mb-3">security@trustfx.com</p>
                    <p className="text-sm text-gray-300">Monitored 24/7 for immediate response</p>
                    <Button
                  ...
                  <div className="bg-white/10 rounded-lg p-6 border border-white/20">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h4 className="text-lg font-semibold text-white">Emergency Hotline</h4>
                    </div>
                    <p className="text-red-200 mb-3">+1 (555) 911-SAFE</p>
                    <p className="text-sm text-gray-300">Available 24/7 for urgent security matters</p>
                    <Button
                      className="w-full mt-4 bg-red-500 hover:bg-red-600 text-white font-semibold transition-all duration-300"
            ...
            <Card className="bg-white/10 backdrop-blur-lg border border-white/20">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white">What to Report</h3>
                </div>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-orange-400 rounded-full mt-2"></div>
                    <span>Suspicious account activity or unauthorized transactions</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-orange-400 rounded-full mt-2"></div>
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-orange-400 rounded-full mt-2"></div>
                    <span>Potential security vulnerabilities in our platform</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-orange-400 rounded-full mt-2"></div>
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-semibold text-white">Critical Security Issues</span>
                      <span className="text-red-400 font-bold\">1 Hour</span>
                    </div>
                    <p className="text-sm text-gray-300">Immediate response for account breaches or fraud</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-semibold text-white">High Priority Issues</span>
                      <span className="text-orange-400 font-bold">4 Hours</span>
                    </div>
                    <p className="text-sm text-gray-300">Platform vulnerabilities and security concerns</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-semibold text-white">General Security Inquiries</span>
                      <span className="text-blue-400 font-bold">24 Hours</span>
                    </div>
                    <p className="text-sm text-gray-300">Security questions and general concerns</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          >
            <Card className="bg-gradient-to-r from-green-600/20 to-blue-600/20 backdrop-blur-lg border border-white/20">
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">Bug Bounty Program</h3>
                <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                  Security researchers can report vulnerabilities for rewards. Help us keep our platform secure and earn
                  recognition for your contributions.
                </p>
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-400 mb-2">$500 - $5,000</div>
                    <div className="text-sm text-gray-300">Reward Range</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-400 mb-2">24/7</div>
                    <div className="text-sm text-gray-300">Submission Review</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-400 mb-2">Hall of Fame</div>
