  ...
  const certifications = [
    {
      ...
      title: "SOC 2 Type II",
      status: "In Progress",
      description: "Comprehensive security, availability, and confidentiality audit",
      color: "text-blue-500",
      bgColor: "bg-blue-50",
    },
    {
    ...
    },
    {
      ...
      title: "SIPC Member",
      status: "Active",
      description: "Securities Investor Protection Corporation coverage up to $500,000",
    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">🧾 Regulatory Compliance</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We maintain the highest standards of regulatory compliance and security certifications to protect your
              ...
              return (
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div className={`inline-flex p-4 rounded-2xl ${cert.bgColor} mb-4`}>
                      <IconComponent className={`w-8 h-8 ${cert.color}`} />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2">{cert.title}</h3>
                    <Badge
                      className={`mb-3 ${
                        cert.status === "Certified" || cert.status === "Active" || cert.status === "Compliant"
            ...
            <Card className="bg-gradient-to-r from-slate-50 to-gray-50 border-2 border-gray-200">
              <CardContent className="p-12">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  {/* Content */}
                  <div>
                    <h3 className="text-3xl font-bold text-gray-900 mb-6">Regulatory Oversight</h3>
                    <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                      TrustFx operates under strict regulatory oversight and maintains compliance with all applicable
                  ...
                  <div className="space-y-6">
                    <h4 className="text-xl font-bold text-gray-900 text-center">Trusted by Regulatory Bodies</h4>
                    <div className="grid grid-cols-2 gap-6">
                      <div className="bg-white rounded-xl p-6 text-center shadow-lg border border-gray-200">
                        ...
                        />
                        <p className="text-sm font-semibold text-gray-700">SEC Oversight</p>
                      </div>
                      <div className="bg-white rounded-xl p-6 text-center shadow-lg border border-gray-200">
                        <Image
                          src="/placeholder.svg?height=60&width=120"
                          ...
                          className="mx-auto mb-2 opacity-80"
                        />
                        <p className="text-sm font-semibold text-gray-700">SIPC Member</p>
                      </div>
                      <div className="bg-white rounded-xl p-6 text-center shadow-lg border border-gray-200">
                        <Image
                          src="/placeholder.svg?height=60&width=120"
                          ...
                          className="mx-auto mb-2 opacity-80"
                        />
                        <p className="text-sm font-semibold text-gray-700">FINRA Member</p>
                      </div>
                      <div className="bg-white rounded-xl p-6 text-center shadow-lg border border-gray-200">
                        <Image
                          src="/placeholder.svg?height=60&width=120"
                          ...
                          className="mx-auto mb-2 opacity-80"
                        />
                        <p className="text-sm font-semibold text-gray-700">PCI DSS Certified</p>
                      </div>
                    </div>
                  </div>
                </div>
