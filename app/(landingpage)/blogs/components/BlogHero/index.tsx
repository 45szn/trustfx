...
export default function BlogHero({ searchTerm, setSearchTerm }: BlogHeroProps) {
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Searching for:", searchTerm);
    // You can scroll down to the blog list here if you like.
  };
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Search Bar */}
        <form onSubmit={handleSearch} className="max-w-2xl mx-auto my-12">
