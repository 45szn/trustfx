  ...
  const standards = [
    {
      ...
      detail:
        "Your investments are protected by the Securities Investor Protection Corporation",
    },
    {
      icon: FileCheck,
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Your security and trust are our top priorities. We meet and exceed
            all industry standards to ensure your investments are protected.
          </p>
        </div>
            ...
            <CardContent className="p-12">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-300">
                  We maintain partnerships and compliance with leading financial
