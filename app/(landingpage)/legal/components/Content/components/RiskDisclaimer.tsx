// file: components/legal/RiskDisclaimer.tsx
"use client";

import { motion } from "framer-motion";
import { AlertTriangle, ChevronDown, ChevronUp } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { riskSections } from "./legalData";
...
export default function RiskDisclaimer({ expanded, onToggle }: Props) {
  return (
    <motion.div
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Important information about the risks associated with investing and
          using our platform.
        </p>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-red-700">
              All investments carry risk and you may lose some or all of your
              money. Past performance does not guarantee future results. Please
